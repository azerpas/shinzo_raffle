...
API_KEY = ''
captcha_url = 'https://raffle.shinzo.paris/wp-json/contact-form-7/v1/contact-forms/234/feedback'
headers = {
        ...
        'Origin':            'http://raffle.shinzo.paris',
        ...
        'Referer': 'http://raffle.shinzo.paris/'
}
